    ...
    <div className="max-w-md mx-auto h-full px-4">
      ...
      <section className="mb-8">
        <motion.div
          ...
          className="bg-primary p-6 rounded-[2rem] text-white shadow-xl shadow-green-200 relative overflow-hidden"
        >
          <div className="relative z-10">
            ...
            <div className="flex gap-4">
              <div className="bg-white/20 px-3 py-1.5 rounded-xl text-xs backdrop-blur-sm">
                🌱 1.2kg CO₂ Saved
              </div>
              <div className="bg-white/20 px-3 py-1.5 rounded-xl text-xs backdrop-blur-sm">
                ✅ 24 Items Scanned
      ...
      <section className="mb-8">
        <h3 className="text-lg font-bold mb-4 px-2">Quick Actions</h3>
        <div className="grid grid-cols-2 gap-4">
          <Card 
            className="flex flex-col items-center justify-center h-32 border-2 border-primary/10 hover:border-primary/30"
            onClick={() => navigate('/scan')}
          >
            <div className="w-12 h-12 bg-primary/10 text-primary rounded-2xl flex items-center justify-center mb-2">
              <Scan size={24} />
            </div>
            <span className="font-bold">Scan Product</span>
          </Card>
          <Card 
            className="flex flex-col items-center justify-center h-32 border-2 border-blue-50 hover:border-blue-100"
